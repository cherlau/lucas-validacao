<template>
  <div>
    ...
    <FormCreateIntegration v-model="showCreateIntegrationModal" @submit="handleCreateIntegration" />
  </div>
</template>
...
import FormCreateIntegration from '@/components/forms/FormCreateIntegration/index.vue'
